  ...
  return (
    <main className="items-center h-screen justify-start lg:flex-row lg:items-start p-4">
      ...
      <div className="p-4 sm:ml-64 ">
        <div className="w-full text-center bg-gray-100 h-full">
          <div className="flex flex-cols justify-between">
            <div className="flex flex-cols p-3 items-center">
              ...
              <h1 className="ml-4 font-bold text-2xl">Image Details</h1>
            </div>
        ...
        <div className="w-full text-center bg-gray-100 h-full flex flex-cols p-4 mt-4">
          <h1 className="ml-4 font-bold text-2xl">File</h1>
        </div>
      </div>
    </main>
  );
